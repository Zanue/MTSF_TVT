...
class Dataset_Spectrum(Dataset):
    def __init__(self, data_path, flag='train', size=None, scale=True):
    ...
    def __read_data__(self):
        ...
        # occupancy = np.array(scio.loadmat(self.data_path)['occupancy_matrix']) # [L, C]
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.features == 'M' or self.features == 'MS':
            ...
            df_data = df_raw[[self.target]]
        print('Data shape: ', df_data.values.shape)
