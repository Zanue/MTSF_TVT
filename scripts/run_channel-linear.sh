...
do 
    ...
    do
        python Evolution.py \
            ...
            --embedding=te \
            --ablation_csv_path=exp_settings/0814_2200_final_ChannelTokens_linear_te.csv \
            --save_ckpt \
            --exp_name=0814_2200_final_te
    done
done
...
do 
    ...
    do
        python Evolution.py --model_type=Transformer_ChannelTokens_noSeg \
            ...
            --ablation_csv_path=exp_settings/0813_1400_final_ChannelTokens_linear.csv \
            --save_ckpt \
            --exp_name=0813_1400_final
    done
done